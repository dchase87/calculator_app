class EquationsController < ApplicationController
  ...
  # POST /equations.json
  def create
    if Equation.new(equation_params).valid?
      @equation = Equation.new(equation_params(:formula))
...
#     # Use callbacks to share common setup or constraints between actions.
    ...
    def equation_params(*args)
      params.require(:equation).permit(*args)
    end
end
